...
def parser_args():
    ...
    parser.add_argument('--exp_dir',
                        type=str,
                        default='D:/weights_results/Pyramidal_ReID/pretrained/market', # 'D:/weights_results/HOReID/pre-trained',  #
    ...
    parser.add_argument('--ow_config_path',
                        type=str,
                        default='D:/Pycharm_Project/HJL-ReID/MDRSREID/Settings/config/overwrite_config/Pyramidal_config_SGD_best_market1501.txt',
